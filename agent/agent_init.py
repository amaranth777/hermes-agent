        ...
        try:
            ...
            if agent._memory_enabled or agent._user_profile_enabled:
                ...
                agent._memory_store = MemoryStore(
                    memory_char_limit=mem_config.get("memory_char_limit", DEFAULT_TIER1_MEMORY_CHAR_LIMIT),
                    user_char_limit=mem_config.get("user_char_limit", DEFAULT_TIER1_USER_CHAR_LIMIT),
                    tier2_char_limit=mem_config.get("tier2_char_limit", DEFAULT_TIER2_CHAR_LIMIT),
                    tier3_char_limit=mem_config.get("tier3_char_limit", DEFAULT_TIER3_CHAR_LIMIT),
                )
